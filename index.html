[index.html.HTML](https://github.com/user-attachments/files/24333974/index.html.HTML)
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            min-height: 100vh;
            -webkit-tap-highlight-color: transparent; /* Quita el highlight azul en móviles al tocar */
        }
        ...
        /* Animación de pulso suave para el botón final */
        .btn-pulse {
        ...
        .hero-image-placeholder {
            width: 180px; /* Un poco más pequeño en móvil por defecto */
            height: 180px;
            border-radius: 50%;
        ...
        /* --- LÍNEA DE TIEMPO --- */
        .timeline-section {
            padding: 80px 15px; /* Menos padding lateral en móvil */
            max-width: 1000px;
            margin: 0 auto;
            position: relative;
        }
        ...
        /* --- SECCIÓN PRE-PROPUESTA (MENSAJE) --- */
        .proposal-section {
            min-height: 70vh; /* Ajuste para móvil */
            display: flex;
            flex-direction: column;
            justify-content: center;
            align-items: center;
        ...
        .proposal-content-wrapper {
            ...
            height: 100%;
            text-align: center;
            overflow-y: auto; /* Permitir scroll si la pantalla es pequeña */
            display: flex;
            flex-direction: column;
        ...
        .proposal-line {
            font-family: 'Playfair Display', serif;
            font-size: 2.8rem; /* Ajustado para móvil */
            color: var(--gold);
            margin: 8px 0;
            opacity: 0;
        ...
        /* Estilos del Temporizador de Decisión (30 seg) */
        #decision-timer-box {
            margin-top: 30px;
            opacity: 0;
            animation: fadeInUp 1s forwards 3.5s; /* Aparece después de la pregunta */
        ...
        /* Contenedor de la Respuesta Final (Cronómetro y Fecha) */
        #final-celebration {
        ...
        .countdown-box {
            ...
            border-radius: 10px;
            flex: 1 1 70px; /* Flexible para móvil */
            max-width: 90px;
        }
        ...
        @media (max-width: 768px) {
            ...
            .hero-image-placeholder { width: 160px; height: 160px; }
            
            /* Ajuste línea de tiempo para móvil (todo a la izquierda) */
            .timeline-line { left: 20px; }
            .timeline-content { width: 100%; padding-left: 50px; padding-right: 0; text-align: left !important; }
            .timeline-item:nth-child(odd) .timeline-content { margin-left: 0; margin-right: 0; }
            .timeline-item:nth-child(even) .timeline-content { margin-left: 0; }
            .timeline-dot { left: 20px; }
            
            /* Ajuste Modal */
            .proposal-line { font-size: 2rem; }
            .countdown-container { gap: 8px; }
            .countdown-box { min-width: 60px; padding: 8px; }
            .count-val { font-size: 1.4rem; }
            .proposal-content-wrapper { padding: 40px 15px; justify-content: flex-start; } /* Scroll desde arriba */
            
            /* Botones */
            .btn-answer { width: 100%; margin: 8px 0; }
            
            /* Videos Youtube */
            .youtube-container { flex-direction: column; align-items: center; }
            .youtube-box { width: 100%; max-width: 100%; }
        }
    </style>
</head>
<body>
    ...
    <button class="theme-toggle" id="theme-btn" aria-label="Cambiar modo">☾</button>
    ...
    <header id="intro-screen">
        <div class="intro-content">
            <div class="hero-image-placeholder">
                <!-- IMAGEN DE GOOGLE DRIVE (IMPORTANTE: Debe ser pública) -->
            ...
            <p class="subtitle">Un viaje que comenzó en las estrellas...</p>
            <button class="btn-gold" id="start-btn">Descubrir Nuestro Camino</button>
        </div>
    </header>

    <!-- 2. TRANSICIÓN -->
    <div id="transition-msg">Nuestro viaje comienza aquí...</div>
    ...
    <main id="main-content">
        ...
        <section class="timeline-section" id="timeline">
            <h2 class="section-title fade-element">El Camino Hacia el Sí</h2>
            ...
            <div class="timeline-container">
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-content glass">
                        ...
                        <p class="timeline-desc">
                            En medio del caos del mundo, encontramos nuestra paz. Las citas en bicicleta y moto fueron el comienzo de una complicidad única. Tu inmensa comprensión frente a mi trabajo incansable me enseñó lo que es el apoyo incondicional.
                        </p>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-content glass">
                        <span class="timeline-icon">🌳</span>
                        <span class="timeline-date">Integración</span>
                        <h3 class="timeline-title">Nuestras Raíces</h3>
                        <p class="timeline-desc">
                            El momento en que conocimos a nuestras familias marcó la unión de dos mundos. Pasamos lindos momentos y construimos los cimientos de lo que hoy somos.
                        </p>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-content glass">
                        ...
                        <h3 class="timeline-title">Perú, Brasil y Más Allá</h3>
                        <p class="timeline-desc">
                            Nuestros pasaportes guardan las memorias de Perú y la promesa de Brasil el próximo año. Viajar contigo es mi destino favorito y nuestro objetivo es seguir explorando el mundo juntos.
                        </p>
                    </div>
                </div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-content glass">
                        ...
                        <p class="timeline-desc">
                            Un sueño materializado en Santa Cruz. Nuestro propio departamento nos espera para llenarlo de vida, risas y crecimiento como emprendedores. Mi gran apoyo, mi socia de vida.
                        </p>
                    </div>
                </div>
        ...
        <!-- 4. SECCIÓN FINAL (REDISEÑADA) -->
        <section class="proposal-section">
            <div class="glass" style="padding: 40px; max-width: 800px; width: 100%;">
                
                <p class="romantic-msg">
                    "Ale, tu amor ha sido mi refugio y mi fuerza. Gracias por abrazar mis sueños y sostener mi mano incluso cuando el tiempo nos faltaba. Eres mi paz absoluta y la inspiración que necesito para crecer cada día."
                </p>

                <!-- BOTÓN REVELADOR -->
                <button id="final-trigger-btn" class="btn-gold btn-pulse" style="margin-top: 20px; font-size: 1.1rem;">
    ...
    <!-- 5. PANTALLA FINAL DE REVELACIÓN (MODAL) -->
    <div id="proposal-screen" class="proposal-screen" aria-hidden="true">
        <div class="proposal-content-wrapper">
            ...
            <!-- CELEBRACIÓN FINAL (CRONÓMETRO + YOUTUBE) -->
            <div id="final-celebration">
                ...
                <p style="font-size:1.3rem; margin-top:20px; margin-bottom:30px; color:var(--gold); font-family:'Playfair Display', serif; font-style:italic; animation:pulse 2s infinite;">Te amo infinito.</p>

                <!-- REPRODUCTORES DE YOUTUBE -->
                <div class="youtube-container" style="display:flex; flex-wrap:wrap; justify-content:center; gap:20px; margin-top:20px;">
                    <div class="youtube-box glass" style="padding:15px; max-width:350px; width: 100%;">
                        <p style="margin-bottom:10px; font-size:0.9rem; color:var(--text-main);">Nuestra canción (Español)</p>
                    ...
                    <div class="youtube-box glass" style="padding:15px; max-width:350px; width: 100%;">
                        <p style="margin-bottom:10px; font-size:0.9rem; color:var(--text-main);">Nuestra canción (Inglés)</p>
                ...
                <button onclick="location.reload()" class="btn-gold" style="margin-top: 40px; font-size: 0.9rem; padding: 12px 25px;">
                    Volver al Inicio
                </button>
    ...
    <script>
        ...
        function openProposal() {
            ...
            decisionTimerBox.style.opacity = '1'; // Se animará por CSS keyframe fadeInUp
            ...
            const timerInterval = setInterval(() => {
                ...
                if (timeLeft <= 0) {
                    ...
                    triggerFinale(); // Activar celebración automática
                }
            }, 1000);
        ...
        // Función que revela la sorpresa final
